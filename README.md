...
| 226  | IM_USED                         | The server has fulfilled the request for the resource, and the response is a representation of the result of one or more instance manipulations applied to the current instance. |
...
| 303  | SEE_OTHER                       | The response can be found under another URI using a GET method.                                                                                                                  |
| 304  | NOT_MODIFIED                    | The resource has not been modified since the last request.                                                                                                                       |
...
| 401  | UNAUTHORIZED                    | The client needs authentication for the response.                                                                                                                                |
...
| 503  | SERVICE_UNAVAILABLE             | The server is not ready to handle the request, usually due to being overloaded or down for maintenance.                                                                          |
